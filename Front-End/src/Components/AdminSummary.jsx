...
import { FcHome, FcConferenceCall, FcDepartment, FcPlanner, FcMoneyTransfer, FcServices , FcFile , FcApproval   } from "react-icons/fc";
  ...
  return (
    <div className='p-6'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-6 mt-6'>
        <SummaryCard icon={<FcFile  />} text='Leave Applied' number={13} />
         <SummaryCard icon={<FcApproval  />} text='Leave Approved' number={5} />
         <SummaryCard icon={<FcMoneyTransfer />} text='Leave Pending' number='₹100000' />
         <SummaryCard icon={<FcMoneyTransfer />} text='Leave Rejected' number='₹100000' />
      </div>
      </div>
    </div>
  );
