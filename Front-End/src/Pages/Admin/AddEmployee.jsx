...
import { FaUser, FaEnvelope, FaIdBadge, FaCalendarAlt, FaVenusMars, FaRing, FaBriefcase, FaBuilding, FaDollarSign, FaLock, FaUserTie, FaImage } from 'react-icons/fa';
...
const AddEmployee = () => {
  ...
  return (
    <div className='max-w-5xl mx-auto mt-12 px-6 py-10 bg-gradient-to-r from-purple-50 via-white to-pink-50 rounded-xl shadow-lg'>
